// A Sera UI component (https://seraui.com/docs/noise) — draws an animated
// (or static) grain/noise texture over a solid color, on a <canvas> layered
// behind whatever content is passed in as children.
"use client";
